...
/**
 * Fuente "Campo amplio" (padre): control dropDownList "CINE_AMPLIO" — FOR ANEXO 1 (2026), 11 ítems reales.
 * Fuente "Campo específico" y "Campo detallado": Clasificación Internacional Normalizada de la
 * Educación (CINE-F 2013, UNESCO). El árbol completo específico/detallado vive comprimido dentro
 * del vbaProject.bin y no pudo descompilarse en este entorno; se completó con los campos oficiales
 * CINE-F 2013 por cada campo amplio. Verificar contra el catálogo institucional si difiere.
 */
...
export const CINE_ESPECIFICO_POR_AMPLIO: Record<string, ICineOpcion[]> = {
  "00": [{ codigo: "001", texto: "001 Programas y certificaciones básicos" }],
  "01": [
    { codigo: "011", texto: "011 Educación" },
    { codigo: "012", texto: "012 Formación de docentes" },
  ],
  "02": [
