export class Carrera {
    ...
    constructor(id: string, nombre: string, sedeUnidadAcademica: string, objetivoNota: string, nroEstudiantesPlanificados: number) {
        this._id = id;
        this._nombre = nombre;
    ...
    public validar():boolean{
        return (
            ...
            this.sedeUnidadAcademica.trim().length > 0 &&
            this.nroEstudiantesPlanificados > 0
        );
    }
}