import { EstadoConvocatoria, convocatoriaAdmiteNotas, convocatoriaEsModificable } from '../enums/EstadoConvocatoria.js'
...
export class Convocatoria {
    ...
    public esModificable(): boolean {
        return convocatoriaAdmiteNotas(this._estado);
    }
    ...
    public marcarVencidasSiCorresponde(): void {
